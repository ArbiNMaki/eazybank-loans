package com.arbi.loans.controller;

import com.arbi.loans.dto.ResponseDto;
import com.arbi.loans.service.ILoansService;
import com.arbi.loans.constants.LoansConstants;
import com.arbi.loans.dto.ErrorResponseDto;
...
@Tag(
        ...
        description = "CRUD REST APIs in EazyBank to CREATE, FETCH, UPDATE AND DELETE loan details"
)
@RestController
@RequestMapping(
        path = "/api",
